...
def main():
    ...
    print("""
  Stage 1 is the current bottleneck.

  Best immediate action:
    1. Install vtracer:  cargo install vtracer  (Rust required)
       OR download binary from: https://github.com/visioncortex/vtracer/releases
    2. Drop a test PNG into:  input\\
    3. Run:  python scripts\\convert_png.py input\\your_file.png

  vtracer produces far cleaner curves than Potrace on organic/cursive art.
  No preprocessing needed for high-contrast black-and-white source images.
""")
